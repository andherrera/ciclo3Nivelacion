    ...
    <div v-if="loaded" class="signUp_user">
        <div class="container_signUp_user">
            ...
            <div>ID producto seleccionado: {{ selectedApp }}</div>
                <button type="button" v-if="!is_auth" v-on:click="findProduct" > Consultar  Producto</button>
                <button type="button" v-if="!is_auth" v-on:click="deleteProduct" > Eliminar  Producto</button>
